...
Quando este navegador é executado pela primeira vez, ele detecta a instalação anterior e faz a atualização, depois disso, não adianta mais fazer a cópia substituindo a configuração anterior, há alguma inteligência que bloqueia repetir o processo várias vezes, então a primeira cópia sempre funciona, as demais, nem sempre.  

----

[Clique aqui para retornar a página principal](../README.md#instalando-o-google-chrome)
